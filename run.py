...
if __name__ == '__main__':
    ...
    parser.add_argument('--i_or_cos', type=int, default=0, help='i or cos')
    parser.add_argument('--base', type=int, default=0, help='number of base')
    parser.add_argument('--sigma', type=float, default=1, help='number of base')
